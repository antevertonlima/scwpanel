...
class Usuarios extends CI_Controller {
	...
	public function login(){
		...
		set_tema('conteudo', load_modulo('usuarios', 'login','scwpanel'));
		set_tema('rodape', '');
		load_template();
	}
	...
	public function nova_senha(){
		...
		set_tema('conteudo', load_modulo('usuarios', 'nova_senha','scwpanel'));
		set_tema('rodape', '');
		load_template();
	}
	...
	public function gerenciar(){
		...
		set_tema('conteudo', load_modulo('usuarios', 'gerenciar','scwpanel'));
		load_template();
	}
	...
	public function alterar_senha(){
		...
		set_tema('conteudo', load_modulo('usuarios', 'alterar_senha','scwpanel'));
		load_template();
	}
	...
	public function editar(){
		...
		set_tema('conteudo', load_modulo('usuarios', 'editar','scwpanel'));
		load_template();
	}
